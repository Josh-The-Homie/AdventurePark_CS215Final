...
public final class ArrayBag<T> {
	...
	public Merchandise[] toArray() {
		checkIntegrity();

		// Create an array of Item to hold the bag's contents
		Merchandise[] result = new Merchandise[numberOfEntries];

		for (int index = 0; index < numberOfEntries; index++) {
			result[index] = (Merchandise) bag[index];
		}
